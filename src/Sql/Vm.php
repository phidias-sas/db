...
class Vm extends \Phidias\Json\Vm
{
    ...
    public static function stmtSearch($expr, $vm)
    {
        ...
        foreach ($words as $word) {
            ...
            $wordConditions[] = "$searchTargetField LIKE " . Utils::escape('%' . $word . '%');
        }
    ...
    public static function op_between($fieldName, $args)
    {
        ...
        $condition = $fieldName . " BETWEEN " . Utils::escape($args[0])  . " AND " . Utils::escape($args[1]);
        return $condition;
    }
